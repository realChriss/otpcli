...
| :--- | :--- | :--- |
| **Windows** | 64-bit | [Download .exe](https://github.com/<YOUR_USERNAME>/<YOUR_REPO_NAME>/releases/latest/download/otpcli-windows-amd64.exe) |
| **Linux** | 64-bit | [Download Binary](https://github.com/<YOUR_USERNAME>/<YOUR_REPO_NAME>/releases/latest/download/otpcli-linux-amd64) |
| **macOS** | Apple Silicon (M1/M2) | [Download Binary](https://github.com/<YOUR_USERNAME>/<YOUR_REPO_NAME>/releases/latest/download/otpcli-darwin-arm64) |
| **macOS** | Intel | [Download Binary](https://github.com/<YOUR_USERNAME>/<YOUR_REPO_NAME>/releases/latest/download/otpcli-darwin-amd64) |
